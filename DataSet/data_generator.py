...
class DataGenerator():
    ...
    def generator(self, X=None, y=None, minmax=True,
        ...
        if realistic_synthetic_mode is not None:
            ...
            if realistic_synthetic_mode == ['dependency', 'local', 'cluster', 'global']:
                ...
                filename = f'{realistic_synthetic_mode}_anomalies_' + self.dataset + '_' + str(self.seed) + '.npz'
                ...
                try:
                    ...
                    # raise NotImplementedError
                    print(f'Generating {realistic_synthetic_mode} anomalies...')
