...
# )
data_list=(campaign mammography "satimage-2" nslkdd fraud ) # from MCM
sim_type='cross_attn'
depth=4
hidden_dim=64
learning_rate=0.001
...
for data in "${data_list[@]}"; do
    exp_name="$model_type-ws-$sim_type-rin-pos_query+token-L$depth-d$hidden_dim-lr$learning_rate"
