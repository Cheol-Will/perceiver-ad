...
from models.RECL.Model import RECL
...
class Trainer(object):
    def __init__(self, model_config: dict, train_config: dict):
        ...
        self.model = RECL(**model_config).to(self.device)
    ...
    def training(self):
        ...
        for epoch in range(self.epochs):
            ...
            for step, (x_input, y_label) in enumerate(self.train_loader):
                ...
                if self.use_amp:
                    with autocast():
                        ...
                        consis_loss = output['consis_loss']
                ...
                running_consis_loss += consis_loss.item()
            ...
            avg_consis_loss = running_consis_loss / len(self.train_loader)

            info = 'Epoch:[{}]\t loss={:.6f}\t recon_loss={:.6f}\t contra_loss={:.6f}\t cycle_loss={:6f}'
            self.logger.info(info.format(epoch, avg_loss, avg_recon_loss, avg_contra_loss, avg_consis_loss))
            self._log_training(epoch, avg_loss, avg_recon_loss, avg_contra_loss, avg_consis_loss)
