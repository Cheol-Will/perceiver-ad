...
from models.TAEDACLv2.Model import TAEDACLv2
...
class Trainer(object):
    def __init__(self, model_config: dict, train_config: dict):
        ...
        self.model = TAEDACLv2(**model_config).to(self.device)
            ...
            for step, (x_input, y_label) in enumerate(self.train_loader):
                ...
                if self.use_amp:
                    with autocast():
                        ...
                        contra_loss = output['contra_loss'].mean()
    ...
    def evaluate(self):
        ...
        for step, (x_input, y_label) in enumerate(self.test_loader):
            ...
            recon = output['recon_loss'].data.cpu()
            contra_score = output['contra_score'].data.cpu()
