...
class TripletMemPAE(nn.Module):
    def __init__(
        ...
        print("Init TripletMemPAE with weight_sharing" if is_weight_sharing else "Init TripletMemPAE without weight sharing")
    ...
    def forward(self, x, return_weight = False, return_pred = False):
        ...
        loss3 = F.mse_loss(x_hat1, x_hat2, reduction='none').mean(dim=1) # keep batch dim
